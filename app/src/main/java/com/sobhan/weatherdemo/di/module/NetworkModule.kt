...
import com.sobhan.weatherdemo.data.repository.WeatherRepositoryImp
...
import com.sobhan.weatherdemo.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideWeatherRepository(appDatabase: AppDatabase,
                               retrofitService: Api): WeatherRepository {
        return WeatherRepositoryImp(appDatabase,retrofitService)
    }
}